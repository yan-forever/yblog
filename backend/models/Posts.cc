...
const std::string Posts::Cols::_status = "status";
...
{"status","std::string","enum('draft','published')",0,0,0,0},
...
const std::string &Posts::getValueOfStatus() const noexcept
{
    static const std::string defaultValue = std::string();
    if(status_)
        return *status_;
...
const std::shared_ptr<std::string> &Posts::getStatus() const noexcept
{
    return status_;
}
void Posts::setStatus(const std::string &pStatus) noexcept
{
    status_ = std::make_shared<std::string>(pStatus);
    dirtyFlag_[4] = true;
}
void Posts::setStatus(std::string &&pStatus) noexcept
{
    status_ = std::make_shared<std::string>(std::move(pStatus));
    dirtyFlag_[4] = true;
}
void Posts::setStatusToNull() noexcept
{
    status_.reset();
    dirtyFlag_[4] = true;
}
